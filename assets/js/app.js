    ...
    var axilInit = {
        ...
        contactForm: function() {
            $('.axil-contact-form').on('submit', function(e) {
                ...
                $.ajax({
                    url: 'https://ushering.fiatledger.org/HM/email',
                    type: 'post',
                    dataType: 'json',
                    data: data,
                    success: function(data) {
                        ...
                        if (data.code === false) {
                            ...
                            _self.find('.subscribe-btn').after('<div class="error-msg"><p>*' + data.err + '</p></div>');
                        } else {
                            $('.error-msg').hide();
                            $('.input-group').removeClass('focused');
                            _self.find('.subscribe-btn').after('<div class="success-msg"><h6 style="color:green;">' + data.success + '</h6></div>');
